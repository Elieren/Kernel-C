...
SRCS_C  := kernel.c graphics/vga/vga.c keyboard/keyboard.c portio/portio.c time/timer.c idt.c pic.c syscall/syscall.c time/clock/clock.c time/clock/rtc.c malloc/malloc.c libc/string.c libc/stack_protector.c power/poweroff.c power/reboot.c multitask/multitask.c tasks/tasks.c ramdisk/ramdisk.c fat16/fs.c graphics/exception_handler/kprint.c graphics/mb2/mb2.c graphics/framebuffer/graphics.c graphics/framebuffer/font.c drivers/ide.c drivers/pci.c spinlock/spinlock.c seqlock/seqlock.c tss/tss.c
