...
static const char welcome_msg[] = "SimpleTerm v0.4";
static const char err_cmd_msg[] = "Command not found: ";
static const char err_cd_msg[] = "cd: failed: ";
static const char hist_fname[] = "history";
static const char hist_fext[] = "";

static uint64_t input_len = 0;
static char *input_buf = 0;
static char *dir_buf = 0;
static char errmsg[ERRMSG_BUF_SIZE];
static unsigned long cwd_res = 0;
...
/* История */
static char *hist_pool = 0; /* HISTORY_MAX * HISTORY_ENTRY_MAX байт  */
static char *hist_fbuf = 0; /* буфер файлового I/O                   */
static char *hist_save = 0; /* сохранение текущего ввода при навигации*/
static int hist_count = 0;
static int hist_idx = -1; /* -1 = не в режиме навигации         */
static int hist_save_len = 0;
